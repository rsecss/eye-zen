...
- 统计服务范式：`src-tauri/src/services/stat/`
...
- 跨界类型定义：`src-tauri/src/models/config.rs`、`src-tauri/src/models/hotkeys.rs`、`src-tauri/src/models/statistics.rs`、`src-tauri/src/models/timer.rs`、`src-tauri/src/models/events.rs`
